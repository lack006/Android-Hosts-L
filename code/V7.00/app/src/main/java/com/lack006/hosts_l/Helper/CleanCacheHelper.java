...
import static com.lack006.hosts_l.Consistent.TEMP_FILE;
import static com.lack006.hosts_l.Consistent.VERSION_FILE;
...
public class CleanCacheHelper {
   ...
   public void cleanCache(Context context) {
    ...
    void cleanChange(Context context) {
    ...
    void cleanClash(Context context) {
    ...
    void cleanHosts(Context context) {
    ...
    void cleanBackup(Context context) {
