...
public class MainActivity extends AppCompatActivity
    ...
    private void showView() {
        ...
        mRefreshBtn = (FloatingActionButton) findViewById(R.id.refresh);
        mRefreshBtn.setOnClickListener(this);

        mButtonAD = (Button) findViewById(R.id.button_ad);
        mButtonRE = (Button) findViewById(R.id.button_re);
        ...
        mCheckBoxHosts = (CheckBox) findViewById(R.id.checkBox_hosts);
        mCheckBoxHosts.setClickable(false);
        mCheckBoxVersion = (CheckBox) findViewById(R.id.checkBox_version);
        mCheckBoxVersion.setClickable(false);
        mCheckBoxBackUp = (CheckBox) findViewById(R.id.checkBox_backup);
        mCheckBoxBackUp.setClickable(false);
        mCheckBoxBusybox = (CheckBox) findViewById(R.id.checkBox_busybox);
        mCheckBoxBusybox.setClickable(false);
        mCheckBoxMark = (CheckBox) findViewById(R.id.checkBox_mark);
        mCheckBoxMark.setClickable(false);
        mCheckBoxLocal = (CheckBox) findViewById(R.id.checkBox_local);
        mCheckBoxLocal.setClickable(false);
        mCheckBoxDNS = (CheckBox) findViewById(R.id.checkBox_dns);
    ...
    private void requestPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_PHONE_STATE}, Consistent.PERMISSIONS_REQUEST);
        } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        switch (requestCode) {
            case Consistent.PERMISSIONS_REQUEST: {
