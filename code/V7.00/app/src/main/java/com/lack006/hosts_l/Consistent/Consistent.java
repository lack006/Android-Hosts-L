...
public class Consistent {
    ...
    public final static int SOFTWARE_VERSION = 52061464;
    ...
    public final static int PERMISSIONS_REQUEST = 6;

    public final static int GET_MARK_ENABLE = 0;

    public final static int GET_HTTPS_ENABLE = 1;

    public final static int GET_MARK_URL = 2;
    ...
    public final static String DEFAULT_SERVER = "1.lack00006.applinzi.com";
