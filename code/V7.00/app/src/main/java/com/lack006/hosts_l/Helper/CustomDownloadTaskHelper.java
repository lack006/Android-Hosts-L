...
import static com.lack006.hosts_l.Consistent.CONNECTED;
import static com.lack006.hosts_l.Consistent.CUSTOM_ERROR;
import static com.lack006.hosts_l.Consistent.DOWNLOAD_CANCEL;
import static com.lack006.hosts_l.Consistent.MIX_HOSTS;
...
public class CustomDownloadTaskHelper {
    ...
    void download(Context context, String url, String[] hosts, boolean[] check, CheckBox checkBox) {
...
//                PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(CACHE_PATH + Consistent.HOSTS_FILE)));
                boolean flag = false;
