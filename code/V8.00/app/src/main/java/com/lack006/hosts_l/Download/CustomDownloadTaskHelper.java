...
import static com.lack006.hosts_l.Consistent.Consistent.MIXING;
...
public class CustomDownloadTaskHelper {
    ...
    private boolean mIsInMixProgress = false;
        ...
        protected void onProgressUpdate(Integer... values) {
            if (!mStopFlag) {
                if (values[0] == CONNECTED) {
                    ...
                    mProgressDialog.cancel();
                } else if (values[0] == MIXING) {
                    mMixProgressDialog.setMessage(mContext.getString(R.string.mix_hosts_count, values[1]));
            ...
            try {
                ...
                while ((line = reReader.readLine()) != null) {
                    ...
                    if (!flag) {
                        ...
                        count++;
                        publishProgress(Consistent.MIXING, count);
                    } else {
                        flag = false;
                    }
